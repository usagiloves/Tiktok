      ...
      for (const o of canceledOrders) {
        if (o.payload) {
          ...
          if (
            ...
            oldFailedDeliveries.push({ orderId: o.orderId, shopId: o.shopId });
          }
        }
      }
      
      console.log(\`Found \${oldFailedDeliveries.length} old failed deliveries. Pushing them all...\`);
      
      let pushed = 0;
      for (const item of oldFailedDeliveries) {
